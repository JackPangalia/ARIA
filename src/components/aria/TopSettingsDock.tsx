...
/** Full-width top strip: hover reveals the icon; entire strip opens settings on click. */
export function TopSettingsDock() {
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-50 h-14 select-none">
      <Link
        href="/settings"
        prefetch
